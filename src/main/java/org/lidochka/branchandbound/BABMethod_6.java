...
class BABMethod_6 implements BABMethod {

    static {
        BABGate.methods[6] = new BABMethod_6();
    }

    public boolean hasOneAuthomorphism(final int[][] matrix) {
        BoolStore store = new BoolStore();
        runFixed0(matrix, store, 0, 1, 2, 3, 4, 5);
        return store.state;
    }

    private void runFixed0(final int[][] matrix, final BoolStore store
            , final int x0, final int x1, final int x2, final int x3, final int x4, final int x5) {
        if (store.state) return;
        runFixed1(matrix, store, x0, x1, x2, x3, x4, x5);
        runFixed1(matrix, store, x1, x0, x2, x3, x4, x5);
        runFixed1(matrix, store, x2, x0, x1, x3, x4, x5);
        runFixed1(matrix, store, x3, x0, x1, x2, x4, x5);
        runFixed1(matrix, store, x4, x0, x1, x2, x3, x5);
        runFixed1(matrix, store, x5, x0, x1, x2, x3, x4);
    }
    ...
    private void runFixed1(final int[][] matrix, final BoolStore store
        ...
        runFixed2(matrix, store, x0, x1, x2, x3, x4, x5);
        runFixed2(matrix, store, x0, x2, x1, x3, x4, x5);
        runFixed2(matrix, store, x0, x3, x1, x2, x4, x5);
        runFixed2(matrix, store, x0, x4, x1, x2, x3, x5);
        runFixed2(matrix, store, x0, x5, x1, x2, x3, x4);
    }
    ...
    private void runFixed2(final int[][] matrix, final BoolStore store
        ...
        runFixed3(matrix, store, x0, x1, x2, x3, x4, x5);
        runFixed3(matrix, store, x0, x1, x3, x2, x4, x5);
        runFixed3(matrix, store, x0, x1, x4, x2, x3, x5);
        runFixed3(matrix, store, x0, x1, x5, x2, x3, x4);
    }
    ...
    private void runFixed3(final int[][] matrix, final BoolStore store
        ...
        runFixed4(matrix, store, x0, x1, x2, x3, x4, x5);
        runFixed4(matrix, store, x0, x1, x2, x4, x3, x5);
        runFixed4(matrix, store, x0, x1, x2, x5, x3, x4);
    }
    ...
    private void runFixed4(final int[][] matrix, final BoolStore store
        ...
        runFixed5(matrix, store, x0, x1, x2, x3, x4, x5);
        runFixed5(matrix, store, x0, x1, x2, x3, x5, x4);
    }
    ...
    private void runFixed5(final int[][] matrix, final BoolStore store
        ...
        runFixed6(matrix, store, x0, x1, x2, x3, x4, x5);
    }
